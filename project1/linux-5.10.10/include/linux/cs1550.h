...
struct cs1550_sem
{
	...
	//create another struct that contatns the task and the mext tasks
	//kind of like a node struct
	struct list_head waiting_task; //list of waiting processes
	
	//glbl sem list
	struct list_head list; //points to next and previous semaphores
};
